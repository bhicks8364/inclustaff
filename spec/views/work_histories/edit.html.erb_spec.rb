...
RSpec.describe "work_histories/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit work_history form" do
    render

    assert_select "form[action=?][method=?]", work_history_path(@work_history), "post" do
